...
Admin.create(:firstName => "Tayyab", :lastName => "Zahid", :userName =>"Tayyab", :email => "admin@admin.com", :password => "helloworld", :contactNumber => "123456789", :type => "Admin", :approved => "true")
Admin.create(:firstName => "Saad", :lastName => "Masood", :userName =>"Saad", :email => "admin@admin.pk", :password => "helloworld", :contactNumber => "123456789", :type => "Admin", :approved => "true")
...
# RouteBusstop.create(:route_id => "1", :busstop_id => "1" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "1", :busstop_id => "2" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "1", :busstop_id => "3" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "1", :busstop_id => "4" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "1", :busstop_id => "5" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "1", :busstop_id => "6" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "1", :busstop_id => "7" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "1", :busstop_id => "8" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "1", :busstop_id => "9" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "1", :busstop_id => "10" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "1", :busstop_id => "11" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "1", :busstop_id => "12" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "1", :busstop_id => "13" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "1", :busstop_id => "14" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "1", :busstop_id => "15" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "1", :busstop_id => "16" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "1", :busstop_id => "17" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "1", :busstop_id => "18" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "1", :busstop_id => "19" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "1", :busstop_id => "20" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "1", :busstop_id => "21" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "1", :busstop_id => "22" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "1", :busstop_id => "23" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "1", :busstop_id => "24" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "1", :busstop_id => "25" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "1", :busstop_id => "26" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "1", :busstop_id => "27" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "1", :busstop_id => "28" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")

# # # B-01 
# RouteBusstop.create(:route_id => "2", :busstop_id => "29" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "2", :busstop_id => "30" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "2", :busstop_id => "31" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "2", :busstop_id => "32" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "2", :busstop_id => "33" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "2", :busstop_id => "34" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "2", :busstop_id => "35" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "2", :busstop_id => "36" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "2", :busstop_id => "37" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "2", :busstop_id => "38" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "2", :busstop_id => "39" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "2", :busstop_id => "40" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "2", :busstop_id => "41" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")

# RouteBusstop.create(:route_id => "3", :busstop_id => "42" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "3", :busstop_id => "43" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "3", :busstop_id => "44" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "3", :busstop_id => "45" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "3", :busstop_id => "46" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "3", :busstop_id => "47" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "3", :busstop_id => "48" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "3", :busstop_id => "49" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "3", :busstop_id => "50" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "3", :busstop_id => "51" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "3", :busstop_id => "52" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "3", :busstop_id => "53" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "3", :busstop_id => "54" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")

# RouteBusstop.create(:route_id => "4", :busstop_id => "55" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "4", :busstop_id => "56" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "4", :busstop_id => "57" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "4", :busstop_id => "58" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "4", :busstop_id => "59" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "4", :busstop_id => "60" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "4", :busstop_id => "61" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "4", :busstop_id => "62" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "4", :busstop_id => "63" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "4", :busstop_id => "64" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "4", :busstop_id => "65" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "4", :busstop_id => "66" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "4", :busstop_id => "67" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")

# RouteBusstop.create(:route_id => "5", :busstop_id => "68" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "5", :busstop_id => "69" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "5", :busstop_id => "70" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "5", :busstop_id => "71" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "5", :busstop_id => "72" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "5", :busstop_id => "73" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "5", :busstop_id => "74" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "5", :busstop_id => "75" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "5", :busstop_id => "76" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "5", :busstop_id => "77" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "5", :busstop_id => "78" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "5", :busstop_id => "79" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "5", :busstop_id => "80" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")

# RouteBusstop.create(:route_id => "6", :busstop_id => "81" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "6", :busstop_id => "82" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "6", :busstop_id => "83" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "6", :busstop_id => "84" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "6", :busstop_id => "85" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "6", :busstop_id => "86" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "6", :busstop_id => "87" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "6", :busstop_id => "88" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "6", :busstop_id => "89" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "6", :busstop_id => "90" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "6", :busstop_id => "91" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "6", :busstop_id => "92" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "6", :busstop_id => "93" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")

# RouteBusstop.create(:route_id => "7", :busstop_id => "94" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "7", :busstop_id => "95" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "7", :busstop_id => "96" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "7", :busstop_id => "97" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "7", :busstop_id => "98" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "7", :busstop_id => "99" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "7", :busstop_id => "100" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "7", :busstop_id => "101" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "7", :busstop_id => "102" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "7", :busstop_id => "103" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "7", :busstop_id => "104" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "7", :busstop_id => "105" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
# RouteBusstop.create(:route_id => "7", :busstop_id => "106" , admin_id: nil, :nextBusStop => "", :bus_stop_sequence_number => "", :nextBusStopDistance => "")
